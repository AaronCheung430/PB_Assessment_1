...
1. [Add blog](#1-add-blog)
   1. [200 Success - Add new blog](#i-example-request-200-success---add-new-blog)
   1. [400 Bad Request - Invalid blog](#ii-example-request-400-bad-request---invalid-blog)
1. [Add comment](#2-add-comment)
   1. [200 Success - Add new comment](#i-example-request-200-success---add-new-comment)
   1. [400 Bad Request - Invalid comment](#ii-example-request-400-bad-request---invalid-comment)
1. [Get author's info](#3-get-authors-info)
   1. [200 Succes - Get Author 2's Info](#i-example-request-200-succes---get-author-2s-info)
   1. [400 Bad Request - Invalid authorID](#ii-example-request-400-bad-request---invalid-authorid)
1. [Get blog's details](#4-get-blogs-details)
   1. [200 Success - Get blog 1's details](#i-example-request-200-success---get-blog-1s-details)
   1. [400 Bad Request - Invalid blogID](#ii-example-request-400-bad-request---invalid-blogid)
1. [Search for authors](#5-search-for-authors)
   1. [200 Success - Exist query](#i-example-request-200-success---exist-query)
   1. [200 Success - Empty query](#ii-example-request-200-success---empty-query)
   1. [200 Success - Invalid query](#iii-example-request-200-success---invalid-query)
1. [Search for blogs](#6-search-for-blogs)
   1. [200 Success - Exist query](#i-example-request-200-success---exist-query-1)
   1. [200 Success - Empty query](#ii-example-request-200-success---empty-query-1)
   1. [200 Success - Invalid query](#iii-example-request-200-success---invalid-query-1)
